  ...
  return (
    <>
      ...
      <button
        ...
        className={
          isNav
            ? "absolute -top-16 right-3 flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-[#2B241D]/10 bg-[#FFFCF5]/90 shadow-[0_6px_18px_rgba(43,36,29,0.16)] backdrop-blur-md transition hover:scale-105 active:scale-95 lg:relative lg:right-auto lg:top-auto lg:h-10 lg:w-10"
      ...
      >
        <span
          ...
          className={`relative block overflow-hidden rounded-full border ${
            isNav
              ? "h-9 w-9 border-[#2B241D]/10 shadow-[0_2px_8px_rgba(43,36,29,0.12)] lg:h-8 lg:w-8"
