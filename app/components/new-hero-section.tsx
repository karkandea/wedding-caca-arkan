...
const HERO_WARM_GRADIENT =
  "radial-gradient(circle at 50% 42%, rgba(255, 210, 140, 0.22) 0%, rgba(255, 210, 140, 0) 48%), linear-gradient(180deg, #C46A2D 0%, #A94724 38%, #7D241C 100%)";
...
export default function NewHeroSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative h-[300vh] w-full bg-[#7D241C]"
      id="new-hero-section"
      style={{ contain: "layout", background: HERO_WARM_GRADIENT }}
    >
